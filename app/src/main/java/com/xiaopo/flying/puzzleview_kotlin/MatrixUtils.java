...
public class MatrixUtils {
  ...
  public static float getMinMatrixScale(PuzzlePiece piece) {
    if (piece != null) {
      ...
      sTempMatrix.reset();
      sTempMatrix.setRotate(-piece.getAngle());
  ...
  static boolean judgeIsImageContainsBorder(PuzzlePiece piece, float rotateDegrees) {
    ...
    sTempMatrix.mapPoints(unrotatedWrapperCorner, piece.getMappedDrawablePoints());
  ...
  static float[] calculateImageIndents(PuzzlePiece piece) {
    ...
    final float[] currentImageCorners = piece.getMappedDrawablePoints();
